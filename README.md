...
![The NestWorth estimator, with area, city, locality, age and furnishing inputs](docs/screenshot-form.png)

![An estimate of Rs 2.39 Cr with its 90% confidence range, model R-squared, and a per-feature breakdown of what moved the price](docs/screenshot-estimate.png)
